...
public class CdhSearchStrategyTest {
  ...
  public void extractClusterNameFromCommandResultWhenCommandResultIsNotJsonStringShouldRaiseStrategyException()
    throws Exception {
    CdhSearchStrategy cdhSearchStrategy = new CdhSearchStrategy();
  ...
  @Test( expected = StrategyException.class )
  public void extractClusterNameFromCommandResultWhenCommandResultIsNotValidJsonStringShouldRaiseStrategyException()
    throws Exception {
    CdhSearchStrategy cdhSearchStrategy = new CdhSearchStrategy();
  ...
  @Test
  public void extractClusterNameFromCommandResultWhenCommandResultIsValidJsonStringShouldReturnClusterName()
    throws Exception {
    CdhSearchStrategy cdhSearchStrategy = new CdhSearchStrategy();

    Assert
      .assertEquals( "cluster", cdhSearchStrategy.extractClusterNameFromCommandResult( "{items: [{name: cluster}]}" ) );
  }
  ...
  public void resolveCommandResultForHDFSWhenCommandResultNotEmptyShouldModifyDownloadableFileList() throws Exception {
    ...
    List<DownloadableFile> actualDownloadableFiles =
      cdhSearchStrategy.resolveCommandResult( "{items: [{name: cluster}]}",
    ...
    Assert.assertEquals( "clusters/cluster/services/hdfs/clientConfig",
      actualDownloadableFiles.get( 0 ).getDownloadPath() );
  }
