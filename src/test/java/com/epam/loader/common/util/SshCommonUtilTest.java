...
public class SshCommonUtilTest {
  ...
  public void executeCommandWhenSessionCannotBeCreatedShouldRaiseCommonUtilException() throws Exception {
    ...
    Mockito.when( sshCommonUtil
      .createDelegationSshSession( Mockito.any( SshCredentials.class ), Mockito.anyString(), Mockito.anyInt() ) )
      .thenThrow( IOException.class );
    Mockito.when( sshCommonUtil
      .executeCommand( Mockito.any( SshCredentials.class ), Mockito.anyString(), Mockito.anyInt(),
        Mockito.anyString() ) )
      .thenCallRealMethod();
  ...
  public void downloadViaSftpWhenSessionCannotBeCreatedShouldRaiseCommonUtilException() throws Exception {
    ...
    Mockito.when( sshCommonUtil
      ...
      .thenThrow( IOException.class );
    Mockito.when( sshCommonUtil
      .downloadViaSftp( Mockito.any( SshCredentials.class ), Mockito.anyString(), Mockito.anyInt(),
        Mockito.anyString() ) )
      .thenCallRealMethod();
